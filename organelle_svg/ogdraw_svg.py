...
class BaseDraw(AttrMerger, abc.ABC):
    ...
    def add_center_text(
        ...
        **attrib: Any,
        ...
        center_text, g = self.center_text_list(rec, genome or "chloroplast")
        if genome is None:
            genome = g
    ...
    @classmethod
    def get_genome_type(cls, rec: SeqRecord, default: str = "chloroplast") -> str:
    ...
    def legend_text(cls, genome_type: str) -> list[tuple[str, str | None]]:
        ...
        if cls.whoami:
            ...
            lines.append(
                (f"generated by {cls.whoami} on {tme.isoformat()}", None),
            )
        return lines
